...
#include "../include/tf2/virtual_rwlock.h"
...
//  mutable tbb::concurrent_vector<RWLockPtr> frame_each_mutex_{};
    ...
    template<typename F>
    int walkToTopParentLatest(F& f, tf2::CompactFrameID target_id, tf2::CompactFrameID source_id, std::string* error_string, ReadChecker &read_checker, tf2::ReadStat *stat = nullptr) const noexcept;
